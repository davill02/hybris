...
/**
 * This is the extension manager of the Musicbandstory extension.
 */
public class MusicbandstoryManager extends GeneratedMusicbandstoryManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MusicbandstoryManager.class);
	 ...
	 */
	public static MusicbandstoryManager getInstance()
	{
		return (MusicbandstoryManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MusicbandstoryConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MusicbandstoryManager() // NOPMD 
	{
		LOG.debug("constructor of MusicbandstoryManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MusicbandstoryManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MusicbandstoryManager called, current tenant: {}", getTenant().getTenantID());
	}
