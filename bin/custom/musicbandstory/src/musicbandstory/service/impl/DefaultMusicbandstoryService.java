...
public class DefaultMusicbandstoryService implements MusicbandstoryService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMusicbandstoryService.class);
	...
	{
		return DefaultMusicbandstoryService.class.getResourceAsStream("/musicbandstory/sap-hybris-platform.png");
	}
