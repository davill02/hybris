...
<html>
<head>
    <title>Welcome to musicbandstory</title>
    <link rel="stylesheet" href="<c:url value="/static/musicbandstory-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "musicbandstory" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/musicbandstory-items.xml</b> - here you can model your items</li>
            <li><b>resources/musicbandstory-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/musicbandstory-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/musicbandstory-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/musicbandstory-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
